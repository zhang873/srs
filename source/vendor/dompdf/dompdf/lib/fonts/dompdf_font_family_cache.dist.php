<?php return array (
  ...
  'firefly' => 
  array (
    'normal' => DOMPDF_DIR . '/lib/fonts/fireflysung',
    'bold' => DOMPDF_DIR . '/lib/fonts/fireflysung',
    'italic' => DOMPDF_DIR . '/lib/fonts/fireflysung',
    'bold_italic' => DOMPDF_DIR . '/lib/fonts/fireflysung',
  ),
    'simhei' =>
  array (
    'normal' => DOMPDF_DIR . '/lib/fonts/SimHei',
    'bold' => DOMPDF_DIR . '/lib/fonts/SimHei',
    'italic' => DOMPDF_DIR . '/lib/fonts/SimHei',
    'bold_italic' => DOMPDF_DIR . '/lib/fonts/SimHei',
  ),
) ?>