...
@section('content')
	...
	<table id="unified_exam_cause" class="table table-striped table-hover text-center table-bordered" width="50%" align="center">
		<thead>
			<tr>
    ...
    <br>
    <div align="center">
        <a href="{{{ URL::to('admin/unified_exam/data_add_unified_exam_cause') }}}" class="btn btn-small btn-info iframe"><span class="glyphicon glyphicon-plus-sign"></span>{{{ Lang::get('admin/unified_exam/table.create_a_new_cause') }}}</a>
    </div>
@stop
...
@section('scripts')
	<script type="text/javascript">
		...
		$(document).ready(function() {
				oTable = $('#unified_exam_cause').dataTable( {
				...
				"bProcessing": true,
		        "bServerSide": true,
		        "sAjaxSource": "{{ URL::to('admin/unified_exam/data_unified_exam_cause') }}",
