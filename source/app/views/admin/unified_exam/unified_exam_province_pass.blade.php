...
@section('content')
    ...
    <form id="passForm" class="form-horizontal" method="post" action="@if (isset($id)){{ URL::to('admin/unified_exam/' . $id . '/unified_exam_province_pass') }}@endif" autocomplete="off">
        <!-- CSRF Token -->
        ...
        <div class="form-group">
            <div class="controls" align="center">
                ...
                <button type="submit" class="btn btn-danger">{{{ Lang::get('general.pass') }}}</button>
            </div>
        </div>
        <!-- ./ form actions -->
    </form>
