...
@section('content')
    ...
    <div class="form-group" align="center">
        <label class="rlbl" >{{ Lang::get('admin/course/title.year') }}</label>
	...
	<table id="courses" class="table table-striped table-hover">
		<thead>
			<tr>
                ...
                <th class="col-md-07">{{{ Lang::get('admin/course/table.is_selected') }}}</th>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
            oTable = $('#courses').dataTable( {
		        ...
		        "bServerSide": true,
		        "ajax": {
                    "url": "{{ URL::to('admin/course/establish_school_browse_data') }}",
                    "data": function ( d ) {
                        ...
                        $("#courses tr").each(function(i) {
                            if (i > 0) {
                                ...
                                if (ck == true)
                                    arr.push($(this).find("td").eq(14).html());
                            }
                        });
                        if (arr.length > 0){
                            d["school[]"] = new Array();
            ...
            $("#btnToNext").click(function(){
                ...
                $.ajax({
                    type: 'GET',
                    url: '{{ URL::to('admin/course/establish_school_next') }}',
                    data: fields,
