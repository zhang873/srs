	...
	<div class="page-header">
		<h3>
			...
			<div class="pull-right">
				<a href="{{{ URL::to('admin/course/module_create') }}}" class="btn btn-small btn-info iframe">
				    <span class="glyphicon glyphicon-plus-sign"></span>{{{ Lang::get('admin/course/title.module_create') }}}</a>
			</div>
		</h3>
	</div>
	...
	<table id="modules" class="table table-striped table-hover">
		<thead>
			<tr>
				...
				<th class="col-md-2">{{{ Lang::get('admin/course/table.module_name') }}}</th>
				<th class="col-md-2">{{{ Lang::get('admin/course/table.module_code') }}}</th>
...
@section('scripts')
	<script type="text/javascript">
		...
		$(document).ready(function() {
				...
				"bProcessing": true,
		        "bServerSide": true,
		        "sAjaxSource": "{{ URL::to('admin/course/module_data') }}",
