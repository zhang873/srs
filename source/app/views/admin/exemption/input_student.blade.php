...
@section('content')
    ...
    <div  class="form-group" align="center">
        <button id="btnQuery" name="btnQuery" value="1" class="btn btn-small btn-info" type="submit">{{{ Lang::get('admin/exemption/table.query') }}}</button>
    </div>
    <br>
    <br>
    <div id="selectStudent">
        ...
        <form id="choose_input" class="form-horizontal" method="post" action="{{URL::to('admin/exemption/student_selection') }}" autocomplete="off">
            ...
            <div  class="form-group" align="center">
                <button id="btnInput" name="btnInput" value="2" class="btn btn-small btn-info" type="submit" >{{{ Lang::get('admin/exemption/table.input_score') }}}</button>
            </div>
        </form>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            oTable = $('#student_id_name').dataTable({
                ...
                "bAutoWidth": true,
                "ajax": {
                    "url": "{{{ URL::to('admin/exemption/data_query') }}}",
                    "data": function (d) {
