...
@section('content')
	...
	<table id="school" class="table table-striped table-hover text-center table-bordered" width="60%" align="center">
		<thead>
			<tr>
                <th class="col-md-2 text-center">{{{ Lang::get('admin/admissions/table.school_name') }}}</th>
    ...
    <br>
    <div align="center">
        <a href="{{{ URL::to('admin/admissions/define_school') }}}" class="btn btn-small btn-info iframe"><span class="glyphicon glyphicon-plus-sign"></span>{{{ Lang::get('admin/admissions/table.create_a_new_school') }}}</a>
    </div>
@stop
