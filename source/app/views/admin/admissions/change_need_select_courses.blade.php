...
@section('content')
    ...
    <div class="form-group" align="center">
        <h3>
            {{ Lang::get('admin/admissions/title.graduate_teaching_plan_query_condition') }}
        </h3>
    </div>
    ...
    <table id="students" class="table table-striped table-hover">
        <caption><h4>{{ Lang::get('admin/admissions/title.teaching_plan_graduate_approval') }}</h4></caption>
        <thead>
            <tr>
                <th class="col-md-1" style="width:20px">{{{ Lang::get('admin/admissions/table.teaching_plan_ID') }}}</th>
                <th class="col-md-1">{{{ Lang::get('admin/admissions/table.student_id') }}}</th>
                <th class="col-md-1" style="width:80px">{{{ Lang::get('admin/admissions/table.student_name') }}}</th>
