    ...
    <table id="students" class="table table-striped table-hover">
        ...
        <thead>
            <tr>
                ...
                <th class="col-md-04">{{{ Lang::get('admin/admissions/table.gender') }}}</th>
                <th class="col-md-04">{{{ Lang::get('admin/admissions/table.nationgroup') }}}</th>
                <th class="col-md-04">{{{ Lang::get('admin/admissions/table.politicalStatus') }}}</th>
                <th class="col-md-04">{{{ Lang::get('admin/admissions/table.jiGuan') }}}</th>
                <th class="col-md-04">{{{ Lang::get('admin/admissions/table.dateofbirth') }}}</th>
                <th class="col-md-03">{{{ Lang::get('admin/admissions/table.source_classification') }}}</th>
                <th class="col-md-04">{{{ Lang::get('admin/admissions/table.graduationSchool') }}}</th>
                <th class="col-md-04">{{{ Lang::get('admin/admissions/table.graduationDate') }}}</th>
                <th class="col-md-04">{{{ Lang::get('admin/admissions/table.graduated_major') }}}</th>
                <th class="col-md-04">{{{ Lang::get('admin/admissions/table.maritalStatus') }}}</th>
                <th class="col-md-04">{{{ Lang::get('admin/admissions/table.ID_number') }}}</th>
                <th class="col-md-04">{{{ Lang::get('admin/admissions/table.phone') }}}</th>
                <th class="col-md-04">{{{ Lang::get('admin/admissions/table.self_address') }}}</th>
                <th class="col-md-04">{{{ Lang::get('admin/admissions/table.postcode') }}}</th>
                <th class="col-md-04">{{{ Lang::get('admin/admissions/table.email') }}}</th>
            </tr>
        </thead>
        <tbody>
        </tbody>
            ...
            $("#btnQuery").click(function(){
                if (oTable == null){
                    oTable = $('#students').dataTable( {
                        ...
                        "bServerSide": true,
                        "ajax": {
                            "url": "{{ URL::to('admin/admissions/basic_student_info_data') }}",
                            "data": function ( d ) {
                        ...
                        "aButtons": [
                            {
                                ...
                                "sFileName": "{{{ Lang::get('admin/admissions/title.student_base_info') }}}.xls",
                                "mColumns": "all"
                            }
                        ]
                    } );
