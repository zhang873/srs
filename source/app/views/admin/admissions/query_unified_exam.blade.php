...
@section('content')
    <div class="form-group" align="center">
        <h3>
            {{ Lang::get('admin/admissions/title.unified_exam_info') }}
        </h3>
    </div>
    <table id="exemption" class="table table-striped table-hover">
        <thead>
            <tr>
                ...
                <th class="col-md-03">{{{ Lang::get('admin/admissions/table.course_name_in') }}}</th>
                ...
                "aButtons": [
                    {
                        ...
                        "sFileName": "{{{ Lang::get('admin/admissions/title.unified_exam_info') }}}.xls",
                        "mColumns": "all"
                    }
                ]
            } );
