    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#form").submit(function () {
                ...
                if ((company_organization!="")  && (company_organization.search(/(^(?!.*?_$)[\u4e00-\u9fa5]+$)/) == -1)) {
                    alert("工作单位只能输入文本信息！");
                    $("#company_organization").focus();
                    return false;
                }

                if ((company_address!="")  && (company_address.search(/(^(?!.*?_$)[\u4e00-\u9fa5]+$)/) == -1)) {
                    alert("单位地址只能输入文本信息！");
                ...
                if ((company_phone!="")  && (!isPhone.test(company_phone))) {
                    alert("请正确填写单位电话，例如:0321-4816048！");
                    $("#company_phone").focus();
                    return false;
                }

                if ((address!="")  && (address.search(/(^(?!.*?_$)[\u4e00-\u9fa5]+$)/) == -1)) {
                    alert("本人通讯地址只能输入文字！");
                    $("#address").focus();
                    return false;
                }
