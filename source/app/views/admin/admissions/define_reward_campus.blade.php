...
{{-- Create Form --}}
<form id="form" name="form" class="form-horizontal" method="post"  autocomplete="off" action="{{URL::to('admin/admissions/'.$id.'/define_reward')}}">
    <!-- CSRF Token -->
    ...
    <div class="form-group" align="center" width="600px">
        ...
        <input type="text" id="reward_date" name="reward_date" readonly style="width:120px "/>&nbsp;&nbsp;
    ...
    <div class="form-group" align="center" width="600px">
        ...
        <input type="text" name="operator" id="actor" style="width:150px;">
    </div>
    <div class="form-group" align="center" width="600px">
