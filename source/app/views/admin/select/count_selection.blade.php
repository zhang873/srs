...
@section('content')
    ...
    <div class="form-group" align="center">
        ...
        <select class="twidth" size="1" tabindex="3" name="campus" id="campus">
            <option value="全部" selected="selected">全部</option>
    ...
    <div class="form-group" align="center">
        ...
        <select class="twidth" size="1" tabindex="7" name="major" id="major">
          <option value="全部" selected="selected">全部</option>
    ...
    <div class="form-group" align="center">
        ...
        <select class="twidth" size="1" tabindex="9" name="year_in" id="year_in">
            <option value="全部" selected="selected">全部</option>
            @if ($cur_year != null)
                @for( $i = 0; $i < 10; $i++)
                    <option value="{{{$cur_year - $i}}}">{{{$cur_year - $i}}}</option>
    ...
    <div class="form-group" align="center">
        ...
        <select class="twidth" size="1" tabindex="11" name="selection_status" id="selection_status">
            <option value="全部" selected="selected">全部</option>
            <option value="1">首次</option>
            <option value="2">再次</option>
        </select>
        <label class="rlbl">{{ Lang::get('admin/select/table.credit') }}</label>
        <input class="twidth" tabindex="12" type="text" name="credit" id="credit">
    </div>

    <div class="form-group" align="center">
        <label class="rlbl">{{ Lang::get('admin/select/title.student_classification') }}</label>
        <select class="twidth" size="1" tabindex="13" name="student_classification" id="student_classification">
            <option value="全部" selected="selected">全部</option>
            <option value="14">专科</option>
            <option value="12">本科</option>
        </select>
        <label style="width:233px;"/>
    </div>
	...
	<table id="detail" class="table table-striped table-hover">
		<thead>
			<tr>
                ...
                <th class="col-md-02">{{{ Lang::get('admin/select/table.campus') }}}</th>
                <th class="col-md-02">{{{ Lang::get('admin/select/table.major') }}}</th>
                <th class="col-md-02">{{{ Lang::get('admin/select/table.course_code') }}}</th>
                <th class="col-md-02">{{{ Lang::get('admin/select/table.course_name') }}}</th>
                <th class="col-md-03">{{{ Lang::get('admin/select/table.is_obligatory') }}}</th>
	...
	<script type="text/javascript">
        ...
        $.initDataTable = function(tab,type){
            ...
            var rst = tab.dataTable( {
                ...
                "bServerSide": true,
                "ajax": {
                    "url": "{{ URL::to('admin/select/count_selection_data') }}",
                    "data": function ( d ) {
                        d["year"]=$('#year').val();
