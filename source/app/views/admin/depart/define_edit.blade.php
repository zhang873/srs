    ...
    <!-- Tabs Content -->
        ...
        <div class="form-group {{{ $errors->has('name') ? 'error' : '' }}}">
            <label class="col-md-2 control-label" for="name">{{{
				Lang::get('admin/depart/table.name') }}}</label>
            <div class="col-md-10">
                @if ($mode == 'create')
                ...
                @else
                    <input class="form-control" type="text" name="name" id="name"
                           value="{{{ $edudepartment->name }}}" /> {{ $errors->first('name', '<span
					class="help-inline">:message</span>') }}
                @endif
            </div>
        </div>
        ...
        <div class="form-group {{{ $errors->has('rank') ? 'error' : '' }}}">
            <label class="col-md-2 control-label" for="rank">{{{
				Lang::get('admin/depart/table.code') }}}</label>
            <div class="col-md-10">
                @if ($mode == 'create')
                ...
                @else
                    <input class="form-control" type="text" name="code" id="code"
                           value="{{{ $edudepartment->code }}}" /> {{ $errors->first('code', '<span
					class="help-inline">:message</span>') }}
                @endif
            </div>
        </div>
